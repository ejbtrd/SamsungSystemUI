...
.field private final mWifiNetworkScoreCacheListener:Landroid/net/wifi/WifiNetworkScoreCache$CacheListener;
...
.method constructor <init>(Landroidx/lifecycle/Lifecycle;Landroid/content/Context;Landroid/net/wifi/WifiManager;Landroid/net/ConnectivityManager;Landroid/net/NetworkScoreManager;Landroid/os/Handler;Landroid/os/Handler;Ljava/time/Clock;JJLcom/android/wifitrackerlib/BaseWifiTracker$BaseWifiTrackerCallback;Ljava/lang/String;)V
    ...
    invoke-direct {v3, p0, v2}, Lcom/android/wifitrackerlib/BaseWifiTracker$4;-><init>(Lcom/android/wifitrackerlib/BaseWifiTracker;Landroid/os/Handler;)V

    iput-object v3, v0, Lcom/android/wifitrackerlib/BaseWifiTracker;->mWifiNetworkScoreCacheListener:Landroid/net/wifi/WifiNetworkScoreCache$CacheListener;

    .line 338
    new-instance v4, Landroid/net/wifi/WifiNetworkScoreCache;

    invoke-direct {v4, p2, v3}, Landroid/net/wifi/WifiNetworkScoreCache;-><init>(Landroid/content/Context;Landroid/net/wifi/WifiNetworkScoreCache$CacheListener;)V

    iput-object v4, v0, Lcom/android/wifitrackerlib/BaseWifiTracker;->mWifiNetworkScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;
    ...
    invoke-direct {v3, p0, v4, v5}, Lcom/android/wifitrackerlib/BaseWifiTracker$Scanner;-><init>(Lcom/android/wifitrackerlib/BaseWifiTracker;Landroid/os/Looper;Lcom/android/wifitrackerlib/BaseWifiTracker$1;)V
    ...
    sput-boolean v3, Lcom/android/wifitrackerlib/BaseWifiTracker;->sVerboseLogging:Z

    .line 343
    new-instance v3, Lcom/samsung/wifitrackerlib/WifiQoSScoredCache;

    new-instance v4, Lcom/android/wifitrackerlib/BaseWifiTracker$5;

    invoke-direct {v4, p0, v2}, Lcom/android/wifitrackerlib/BaseWifiTracker$5;-><init>(Lcom/android/wifitrackerlib/BaseWifiTracker;Landroid/os/Handler;)V

    invoke-direct {v3, p2, v4}, Lcom/samsung/wifitrackerlib/WifiQoSScoredCache;-><init>(Landroid/content/Context;Lcom/samsung/wifitrackerlib/WifiQoSScoredCache$SemCacheListener;)V
...
.method public connectToSmartMHS(Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/samsung/android/wifi/SemWifiManager;->connectToSmartMHS(Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;I)Z
...
.method public onStart()V
    ...
    .line 394
    iget-object v0, p0, Lcom/android/wifitrackerlib/BaseWifiTracker;->mWifiNetworkScoreCache:Landroid/net/wifi/WifiNetworkScoreCache;

    iget-object v1, p0, Lcom/android/wifitrackerlib/BaseWifiTracker;->mWifiNetworkScoreCacheListener:Landroid/net/wifi/WifiNetworkScoreCache$CacheListener;
