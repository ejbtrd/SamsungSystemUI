...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/wifitrackerlib/StandardWifiEntry$StandardWifiEntryKey;Landroid/net/wifi/WifiManager;Landroid/net/wifi/WifiNetworkScoreCache;Z)V
    ...
    invoke-static {p1}, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->isWpa3SaeSupported(Landroid/net/wifi/WifiManager;)Z
    ...
    invoke-static {p1}, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->isWpa3SuiteBSupported(Landroid/net/wifi/WifiManager;)Z
    ...
    invoke-static {p1}, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->isEnhancedOpenSupported(Landroid/net/wifi/WifiManager;)Z
...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/wifitrackerlib/StandardWifiEntry$StandardWifiEntryKey;Ljava/util/List;Ljava/util/List;Landroid/net/wifi/WifiManager;Landroid/net/wifi/WifiNetworkScoreCache;Z)V
    ...
    invoke-virtual {p1, p0}, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->updateFlags(Landroid/net/wifi/WifiConfiguration;)V
...
.method public declared-synchronized connect(Lcom/android/wifitrackerlib/WifiEntry$ConnectCallback;)V
    ...
    .line 425
    invoke-virtual {v1, v0}, Landroid/net/wifi/WifiConfiguration;->setSecurityParams(I)V
    ...
    invoke-static {v2, v3}, Lcom/android/wifitrackerlib/Utils;->shouldSetHiddenSsid(Ljava/lang/String;Landroid/net/wifi/WifiManager;)Z
    ...
    .line 428
    iput v0, v1, Landroid/net/wifi/WifiConfiguration;->macRandomizationSetting:I

    .line 429
    iput v0, p1, Landroid/net/wifi/WifiConfiguration;->macRandomizationSetting:I
    ...
    .line 442
    invoke-static {p0}, Lcom/samsung/wifitrackerlib/SemWifiUtils;->isSupportRandomMac(Lcom/android/wifitrackerlib/WifiEntry;)Z
    ...
    invoke-static {v0}, Lcom/samsung/wifitrackerlib/SemWifiUtils;->isSimCredential(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    invoke-static {v0}, Lcom/samsung/wifitrackerlib/SemWifiUtils;->isSimCheck(Landroid/content/Context;)Z
    ...
    const-string v1, "Abnormal open network "
...
.method public declared-synchronized getSummary(Z)Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/android/wifitrackerlib/StandardWifiEntry;->mRecommendationServiceLabel:Ljava/lang/String;
    ...
    iget-boolean v1, p1, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->networkScoringUiEnabled:Z
    ...
    invoke-static {v1, p0, p1}, Lcom/android/wifitrackerlib/Utils;->getSpeedDescription(Landroid/content/Context;Lcom/android/wifitrackerlib/WifiEntry;Lcom/samsung/wifitrackerlib/WifiEntryFlags;)Ljava/lang/String;
    ...
    invoke-static {p1, p0, v1}, Lcom/android/wifitrackerlib/Utils;->getNetworkTypeDescription(Landroid/content/Context;Lcom/android/wifitrackerlib/WifiEntry;Lcom/samsung/wifitrackerlib/WifiEntryFlags;)Ljava/lang/String;
    ...
    iget-boolean p1, p1, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->isTencentRiskAp:Z
...
.method declared-synchronized getWifiInfoDescription()Ljava/lang/String;
    ...
    .line 1221
    invoke-virtual {p0}, Lcom/android/wifitrackerlib/WifiEntry;->semHasSamsungScore()Z
    ...
    iget-object v2, p0, Lcom/android/wifitrackerlib/WifiEntry;->mSemFlags:Lcom/samsung/wifitrackerlib/WifiEntryFlags;

    invoke-static {v1, p0, v2}, Lcom/android/wifitrackerlib/Utils;->getSpeedDescription(Landroid/content/Context;Lcom/android/wifitrackerlib/WifiEntry;Lcom/samsung/wifitrackerlib/WifiEntryFlags;)Ljava/lang/String;
...
.method declared-synchronized onScoreCacheUpdated()V
    ...
    iget-boolean v0, v0, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->hasSamsungScore:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public semIsOllehGigaAp()Z
    ...
    iget-boolean v0, v0, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->hasVHTVSICapabilities:Z
    ...
    invoke-static {v1}, Lcom/android/wifitrackerlib/Utils;->getBestScanResultByLevel(Ljava/util/List;)Landroid/net/wifi/ScanResult;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->updateFlags(Landroid/net/wifi/ScanResult;)V
    ...
    iget-boolean p0, p0, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->hasVHTVSICapabilities:Z
...
.method public declared-synchronized semUpdateScores(Lcom/samsung/wifitrackerlib/WifiQoSScoredCache;)V
    ...
    iget-object v3, v3, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->qoSScoredNetworkCache:Ljava/util/Map;
...
.method public semUpdateSpeed()Z
    ...
    iget-object v3, p0, Lcom/android/wifitrackerlib/StandardWifiEntry;->mTargetScanResults:Ljava/util/List;
    ...
    iput v1, v3, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->networkType:I
...
.method declared-synchronized updateConfig(Ljava/util/List;)V
    ...
    invoke-virtual {p1, v0}, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->updateFlags(Landroid/net/wifi/WifiConfiguration;)V
...
.method declared-synchronized updateScanResultInfo(Ljava/util/List;)V
    ...
    invoke-virtual {v0}, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->removeAllCapabilities()V
    ...
    invoke-virtual {v3, v2}, Lcom/samsung/wifitrackerlib/WifiEntryFlags;->updateFlags(Landroid/net/wifi/ScanResult;)V
    ...
    invoke-static {v1, v2}, Lcom/android/wifitrackerlib/Utils;->getSecurityTypesFromScanResult(Landroid/net/wifi/ScanResult;Landroid/content/Context;)Ljava/util/List;
