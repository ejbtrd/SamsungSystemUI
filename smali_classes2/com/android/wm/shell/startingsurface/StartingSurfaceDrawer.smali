...
.method private synthetic lambda$removeWindowSynced$5(Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$StartingWindowRecord;)V
    ...
    .line 635
    invoke-static {p1}, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$StartingWindowRecord;->access$300(Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$StartingWindowRecord;)Landroid/view/View;
...
.method private onAppSplashScreenViewRemoved(IZ)V
    ...
    const-string/jumbo p0, "the splash screen. Releasing SurfaceControlViewHost for task:"
...
.method private removeWindowInner(Landroid/view/View;Z)V
    ...
    const-string p1, "DecorView is not currently attached."
...
.method addSplashScreenStartingWindow(Landroid/window/StartingWindowInfo;Landroid/os/IBinder;I)V
    ...
    .line 202
    invoke-virtual {v4, v11, v12, v13}, Landroid/content/Context;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;
    ...
    .line 219
    invoke-virtual {v11, v5}, Landroid/content/Context;->setTheme(I)V
    ...
    .line 222
    invoke-virtual {v5, v14, v13}, Landroid/content/res/TypedArray;->getResourceId(II)I
    ...
    const-string v6, "addSplashScreen: apply overrideConfig"
    ...
    invoke-direct {v11, v2}, Landroid/view/WindowManager$LayoutParams;-><init>(I)V

    .line 244
    invoke-virtual {v11, v13}, Landroid/view/WindowManager$LayoutParams;->setFitInsetsSides(I)V

    .line 245
    invoke-virtual {v11, v13}, Landroid/view/WindowManager$LayoutParams;->setFitInsetsTypes(I)V

    const/4 v2, -0x3

    .line 246
    iput v2, v11, Landroid/view/WindowManager$LayoutParams;->format:I
    ...
    .line 261
    iget v6, v11, Landroid/view/WindowManager$LayoutParams;->layoutInDisplayCutoutMode:I

    invoke-virtual {v4, v5, v6}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v5

    iput v5, v11, Landroid/view/WindowManager$LayoutParams;->layoutInDisplayCutoutMode:I
    ...
    iput v5, v11, Landroid/view/WindowManager$LayoutParams;->windowAnimations:I
    ...
    iput-object v1, v11, Landroid/view/WindowManager$LayoutParams;->packageName:Ljava/lang/String;
    ...
    iput v1, v11, Landroid/view/WindowManager$LayoutParams;->privateFlags:I
    ...
    invoke-virtual {v11, v1}, Landroid/view/WindowManager$LayoutParams;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 311
    invoke-virtual {v6, v13, v13, v13, v13}, Landroid/widget/FrameLayout;->setPadding(IIII)V

    .line 312
    invoke-virtual {v6, v13}, Landroid/widget/FrameLayout;->setFitsSystemWindows(Z)V

    .line 313
    new-instance v13, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$$ExternalSyntheticLambda5;
    ...
    .line 336
    new-instance v6, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$$ExternalSyntheticLambda7;

    invoke-direct {v6, v14}, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$$ExternalSyntheticLambda7;-><init>(Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$SplashScreenViewSupplier;)V
    ...
    invoke-virtual {v1, v2, v13, v15}, Landroid/view/Choreographer;->postCallback(ILjava/lang/Runnable;Ljava/lang/Object;)V
...
.method protected addWindow(ILandroid/os/IBinder;Landroid/view/View;Landroid/view/WindowManager;Landroid/view/WindowManager$LayoutParams;I)Z
    ...
    const-string/jumbo v0, "view not successfully added to wm, removing view"
...
.method public preloadSplashScreenAppIcon(Landroid/content/pm/ActivityInfo;ILandroid/content/res/Configuration;)V
    ...
    .line 372
    iget-object v0, p0, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer;->mContext:Landroid/content/Context;

    const/4 v1, 0x0

    .line 374
    invoke-direct {p0, v1, p1}, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer;->getSplashScreenTheme(ILandroid/content/pm/ActivityInfo;)I
    ...
    const-string/jumbo v5, "preloadSplashScreenAppIcon "
    ...
    .line 378
    invoke-direct {p0, v0, v1}, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer;->getDisplayContext(Landroid/content/Context;I)Landroid/content/Context;
    ...
    invoke-static {p3, p1, p0}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-virtual {p3, p2}, Landroid/content/res/Configuration;->diffPublicOnly(Landroid/content/res/Configuration;)I
    ...
    .line 399
    sget-boolean p2, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer;->DEBUG_SPLASH_SCREEN:Z
    ...
    const-string v5, "addSplashScreen: creating context based on task Configuration "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v4, p3}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v5, " for splash screen"
    ...
    const-string v0, "addSplashScreen: apply overrideConfig"

    invoke-virtual {p2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p2, p3}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v0, " to starting window resId="
    ...
    const-string p1, "failed creating starting window for global config"
    ...
    invoke-virtual {p0, v0, p1, p3, v2}, Lcom/android/wm/shell/startingsurface/SplashscreenContentDrawer;->preloadSplashScreenAppIcon(Landroid/content/Context;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;I)V
...
.method public removeSplashScreenAppIcon(Landroid/content/pm/ActivityInfo;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/wm/shell/startingsurface/SplashscreenContentDrawer;->removeSplashScreenAppIcon(Landroid/content/pm/ActivityInfo;)V
    ...
    const-string v1, "info is null or empty while removing, info : "
...
.method protected removeWindowSynced(ILandroid/view/SurfaceControl;Landroid/graphics/Rect;Z)V
    ...
    .line 624
    invoke-static {v0}, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$StartingWindowRecord;->access$300(Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$StartingWindowRecord;)Landroid/view/View;
    ...
    .line 629
    invoke-static {v0}, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$StartingWindowRecord;->access$400(Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$StartingWindowRecord;)I
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$$ExternalSyntheticLambda6;-><init>(Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer;Lcom/android/wm/shell/startingsurface/StartingSurfaceDrawer$StartingWindowRecord;)V
