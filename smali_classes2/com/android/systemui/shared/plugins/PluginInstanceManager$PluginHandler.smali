...
.method private getSubDisplayContext(I)Landroid/content/Context;
    .locals 2
    ...
    invoke-static {p0}, Lcom/android/systemui/shared/plugins/PluginInstanceManager;->access$500(Lcom/android/systemui/shared/plugins/PluginInstanceManager;)Landroid/content/Context;
...
.method protected handleLoadPlugin(Landroid/content/ComponentName;)Lcom/android/systemui/shared/plugins/PluginInstanceManager$PluginInfo;
    ...
    invoke-static {v0}, Lcom/android/systemui/shared/plugins/PluginInstanceManager;->access$1300(Lcom/android/systemui/shared/plugins/PluginInstanceManager;)Z
    ...
    invoke-virtual {v0, v12, v14, v6}, Landroid/content/pm/PackageManager;->getApplicationInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-static {v6}, Lcom/android/systemui/shared/plugins/PluginInstanceManager;->access$1400(Lcom/android/systemui/shared/plugins/PluginInstanceManager;)I
    ...
    invoke-direct {v1, v6}, Lcom/android/systemui/shared/plugins/PluginInstanceManager$PluginHandler;->getSubDisplayContext(I)Landroid/content/Context;
    ...
    invoke-virtual {v6, v12, v14, v8}, Landroid/content/Context;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;

    move-result-object v6

    invoke-direct {v7, v6, v0}, Lcom/android/systemui/shared/plugins/PluginInstanceManager$PluginContextWrapper;-><init>(Landroid/content/Context;Ljava/lang/ClassLoader;)V
    ...
    .line 387
    :cond_4
    new-instance v6, Lcom/android/systemui/shared/plugins/PluginInstanceManager$PluginContextWrapper;
    ...
    invoke-virtual {v7, v12, v14, v8}, Landroid/content/Context;->createPackageContextAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)Landroid/content/Context;

    move-result-object v7

    invoke-direct {v6, v7, v0}, Lcom/android/systemui/shared/plugins/PluginInstanceManager$PluginContextWrapper;-><init>(Landroid/content/Context;Ljava/lang/ClassLoader;)V
    ...
    invoke-static {v6}, Lcom/android/systemui/shared/plugins/PluginInstanceManager;->access$1500(Lcom/android/systemui/shared/plugins/PluginInstanceManager;)Lcom/android/systemui/shared/plugins/VersionInfo;
    ...
    .line 439
    invoke-static {v1}, Lcom/android/systemui/shared/plugins/PluginInstanceManager;->access$1500(Lcom/android/systemui/shared/plugins/PluginInstanceManager;)Lcom/android/systemui/shared/plugins/VersionInfo;
