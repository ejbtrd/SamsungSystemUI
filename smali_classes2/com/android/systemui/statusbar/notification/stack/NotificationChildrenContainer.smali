...
.field private mClipEnd:F

.field private mClipStart:F
...
.field private mDefaultRoundness:F
...
.method private initDimens()V
    ...
    sget v2, Lcom/android/systemui/R$dimen;->notification_corner_radius:I
    ...
    iput v1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mDefaultRoundness:F
...
.method private updateChildrenClipping()V
    ...
    invoke-virtual {v4}, Landroid/view/NotificationHeaderView;->getTranslationY()F
    ...
    invoke-virtual {v4, v2}, Landroid/view/NotificationHeaderView;->setClipBottomAmount(I)V
    ...
    invoke-virtual {v2, v3}, Landroid/view/NotificationHeaderView;->setClipBottomAmount(I)V
...
.method public applyHeaderViewBottomRounded(FF)V
    .locals 3
    ...
    .line 286
    :cond_0
    iput p1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mClipStart:F

    .line 287
    iput p2, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mClipEnd:F
    ...
    iget p2, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mDividerHeight:I
    ...
    invoke-virtual {p2}, Landroid/view/NotificationHeaderView;->getHeight()I
    ...
    .line 291
    iget v1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mClipStart:F

    cmpl-float v1, p1, v1

    if-lez v1, :cond_1

    iget v1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mClipEnd:F
    ...
    invoke-virtual {p0, p1}, Landroid/view/NotificationHeaderView;->setDistanceToBottomRoundness(F)V
...
.method public applyState()V
    ...
    .line 807
    invoke-virtual {v3, v4, v4, v2, v2}, Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;->setFakeShadowIntensity(FFII)V
    ...
    .line 811
    iput-boolean v2, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNeverAppliedGroupState:Z
...
.method protected onMeasure(II)V
    ...
    .line 260
    :cond_9
    iput v5, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mRealHeight:I
...
.method public onNotificationUpdated()V
    ...
    invoke-virtual {v0, p0, v3}, Lcom/android/systemui/noticolorpicker/NotificationColorPicker;->getAppPrimaryColor(Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;Z)I
...
.method public recreateNotificationHeader(Landroid/view/View$OnClickListener;Z)V
    ...
    .line 402
    const-class p1, Lcom/android/systemui/noticolorpicker/NotificationColorPicker;

    invoke-static {p1}, Lcom/android/systemui/Dependency;->get(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/android/systemui/noticolorpicker/NotificationColorPicker;
    ...
    invoke-virtual {p1, p2, p0}, Lcom/android/systemui/noticolorpicker/NotificationColorPicker;->updateHeader(Landroid/view/View;Lcom/android/systemui/statusbar/notification/row/ExpandableNotificationRow;)V
...
.method public setClipTopAmount(I)V
    ...
    .line 1136
    iput p1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mClipTopAmount:I
    ...
    .line 1138
    invoke-virtual {v0, p1}, Landroid/view/NotificationHeaderView;->setClipTopAmount(I)V
...
.method public setCurrentBottomRoundness(F)V
    ...
    .line 1401
    :cond_1
    iget v1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mDefaultRoundness:F
...
.method public startAnimationToState(Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;)V
    ...
    .line 881
    invoke-virtual {v4, v2, p1}, Lcom/android/systemui/statusbar/notification/stack/ExpandableViewState;->animateTo(Landroid/view/View;Lcom/android/systemui/statusbar/notification/stack/AnimationProperties;)V

    .line 898
    invoke-virtual {v2, v1, v1, v3, v3}, Lcom/android/systemui/statusbar/notification/row/ActivatableNotificationView;->setFakeShadowIntensity(FFII)V
    ...
    .line 901
    iget-boolean v2, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNeverAppliedGroupState:Z

    if-eqz v2, :cond_4

    .line 902
    iget-object v2, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mGroupOverFlowState:Lcom/android/systemui/statusbar/notification/stack/ViewState;

    iget v4, v2, Lcom/android/systemui/statusbar/notification/stack/ViewState;->alpha:F

    .line 903
    iput v1, v2, Lcom/android/systemui/statusbar/notification/stack/ViewState;->alpha:F

    .line 904
    invoke-virtual {v2, v0}, Lcom/android/systemui/statusbar/notification/stack/ViewState;->applyToView(Landroid/view/View;)V
...
.method public updateHeaderForExpansion(Z)V
    ...
    .line 1085
    invoke-virtual {v0, v1}, Lcom/android/systemui/noticolorpicker/NotificationColorPicker;->getNotificationBgColor(I)I
    ...
    invoke-virtual {v0, v1, v1}, Landroid/view/NotificationHeaderView;->setRoundness(FF)V

    .line 1091
    iget-object v0, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNotificationHeader:Landroid/view/NotificationHeaderView;

    invoke-virtual {v0, p1}, Landroid/view/NotificationHeaderView;->setHeaderBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    .line 1093
    iget-object p1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNotificationHeader:Landroid/view/NotificationHeaderView;

    invoke-virtual {p1, v1}, Landroid/view/NotificationHeaderView;->setOutlineAlpha(F)V

    .line 1094
    iget-object p1, p0, Lcom/android/systemui/statusbar/notification/stack/NotificationChildrenContainer;->mNotificationHeader:Landroid/view/NotificationHeaderView;

    invoke-virtual {p1}, Landroid/view/NotificationHeaderView;->invalidateOutline()V
    ...
    invoke-virtual {p1, p0}, Landroid/view/NotificationHeaderView;->setCurrentTopRoundness(F)V
