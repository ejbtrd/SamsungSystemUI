...
.field protected mIsInDemoMode:Z
...
.method public constructor <init>(Landroid/view/ViewGroup;Lcom/android/systemui/statusbar/CommandQueue;)V
    ...
    iput-object v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController$IconManager;->mBlockList:Ljava/util/ArrayList;

    const/4 v1, 0x0

    .line 294
    iput-object v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController$IconManager;->mFeatureFlags:Lcom/android/systemui/statusbar/FeatureFlags;
    ...
    .line 301
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/StatusBarIconController$IconManager;->applyIconScaling()V

    .line 304
    :cond_0
    new-instance p0, Lcom/android/systemui/util/Utils$DisableStateTracker;

    const/4 v1, 0x2

    invoke-direct {p0, v0, v1, p2}, Lcom/android/systemui/util/Utils$DisableStateTracker;-><init>(IILcom/android/systemui/statusbar/CommandQueue;)V
    ...
    .line 309
    invoke-virtual {p0, p1}, Lcom/android/systemui/util/Utils$DisableStateTracker;->onViewAttachedToWindow(Landroid/view/View;)V

    :cond_1
    return-void
.end method

.method private updateScaleAndLayout()V
    .locals 5
...
.method protected addHolder(ILjava/lang/String;ZLcom/android/systemui/statusbar/phone/StatusBarIconHolder;)Lcom/android/systemui/statusbar/StatusIconDisplayable;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/systemui/statusbar/phone/StatusBarIconController$IconManager;->addMPTCPIcon(ILjava/lang/String;Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MPTCPIconState;)Lcom/android/systemui/statusbar/StatusBarMPTCPView;
...
.method protected addMPTCPIcon(ILjava/lang/String;Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MPTCPIconState;)Lcom/android/systemui/statusbar/StatusBarMPTCPView;
    .locals 0

    .line 545
    invoke-virtual {p0, p2}, Lcom/android/systemui/statusbar/phone/StatusBarIconController$IconManager;->onCreateStatusBarMPTCPView(Ljava/lang/String;)Lcom/android/systemui/statusbar/StatusBarMPTCPView;

    move-result-object p2

    .line 546
    invoke-virtual {p2, p3}, Lcom/android/systemui/statusbar/StatusBarMPTCPView;->applyMPTCPState(Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MPTCPIconState;)V
...
.method protected applyIconScaling()V
    .locals 2
...
.method protected forceUpdateSignalClusterIcons(Landroid/view/View;)V
    .locals 0
    ...
    .line 637
    :cond_0
    instance-of p0, p1, Lcom/android/systemui/statusbar/StatusBarMobileView;
    ...
    .line 639
    invoke-virtual {p1}, Lcom/android/systemui/statusbar/StatusBarMobileView;->forceUpdateState()V

    goto :goto_0

    .line 640
    :cond_1
    instance-of p0, p1, Lcom/android/systemui/statusbar/StatusBarWifiView;
    ...
    .line 642
    invoke-virtual {p1}, Lcom/android/systemui/statusbar/StatusBarWifiView;->forceUpdateState()V

    goto :goto_0

    .line 649
    :cond_2
    instance-of p0, p1, Lcom/android/systemui/statusbar/StatusBarMPTCPView;

    if-eqz p0, :cond_3

    .line 650
    check-cast p1, Lcom/android/systemui/statusbar/StatusBarMPTCPView;

    .line 651
    invoke-virtual {p1}, Lcom/android/systemui/statusbar/StatusBarMPTCPView;->forceUpdateState()V
...
.method protected forceUpdateState()V
    ...
    const-string v1, "forceUpdateState() mIconSize:"
    ...
    .line 622
    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController$IconManager;->mType:Lcom/android/systemui/statusbar/phone/StatusBarIconController$IconManager$GroupType;
...
.method protected onCreateStatusBarMPTCPView(Ljava/lang/String;)Lcom/android/systemui/statusbar/StatusBarMPTCPView;
    .locals 0

    .line 553
    iget-object p0, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController$IconManager;->mContext:Landroid/content/Context;

    invoke-static {p0, p1}, Lcom/android/systemui/statusbar/StatusBarMPTCPView;->fromContext(Landroid/content/Context;Ljava/lang/String;)Lcom/android/systemui/statusbar/StatusBarMPTCPView;
...
.method protected onCreateStatusBarMobileView(Ljava/lang/String;)Lcom/android/systemui/statusbar/StatusBarMobileView;
    .locals 1
    ...
    invoke-static {p0, p1, v0}, Lcom/android/systemui/statusbar/StatusBarMobileView;->fromContext(Landroid/content/Context;Ljava/lang/String;Z)Lcom/android/systemui/statusbar/StatusBarMobileView;
...
.method protected onCreateStatusBarWifiView(Ljava/lang/String;)Lcom/android/systemui/statusbar/StatusBarWifiView;
    .locals 0
...
.method protected onDensityOrFontScaleChanged()V
    ...
    .line 449
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/StatusBarIconController$IconManager;->updateScaleAndLayout()V
...
.method public onSetMPTCPIcon(ILcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MPTCPIconState;)V
    ...
    .line 560
    invoke-virtual {p0, p2}, Lcom/android/systemui/statusbar/StatusBarMPTCPView;->applyMPTCPState(Lcom/android/systemui/statusbar/phone/StatusBarSignalPolicy$MPTCPIconState;)V
...
.method protected onSmallestScreenWidthChanged()V
    .locals 1
...
.method protected setHeightAndCenter(Landroid/widget/ImageView;I)V
    .locals 1
