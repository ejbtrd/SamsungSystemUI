...
.method public connect(Landroid/content/Context;Lcom/samsung/android/app/scrollcapture/lib/RemoteScrollCaptureInterface$ConnectionListener;)Z
    ...
    .line 46
    iget-object v3, p0, Lcom/samsung/android/app/scrollcapture/lib/RemoteScrollCaptureInterface;->mService:Lcom/samsung/android/app/scrollcapture/lib/IScrollCaptureService;
    ...
    .line 51
    :cond_0
    iget-object v3, p0, Lcom/samsung/android/app/scrollcapture/lib/RemoteScrollCaptureInterface;->mConnection:Landroid/content/ServiceConnection;
    ...
    invoke-direct {p1, p0, v1, v2}, Lcom/samsung/android/app/scrollcapture/lib/RemoteScrollCaptureInterface$1;-><init>(Lcom/samsung/android/app/scrollcapture/lib/RemoteScrollCaptureInterface;J)V
    ...
    invoke-static {p2, v1}, Lcom/samsung/android/app/scrollcapture/lib/RemoteScrollCaptureInterface;->isPackageAvailable(Landroid/content/Context;Ljava/lang/String;)Z

    move-result p2

    const-string v2, "com.samsung.android.app.scrollcapture.core.ScrollCaptureRemoteService"

    if-eqz p2, :cond_2

    const-string p2, "SmartCapture will be binded."
    ...
    :cond_2
    const-string p2, "ScrollCapture will be binded."
    ...
    invoke-virtual {p2, p1, v1, v4}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z

    move-result p1

    if-nez p1, :cond_4

    const-string p2, "connect : bindService failed"
    ...
    .line 91
    invoke-interface {p2, v5}, Lcom/samsung/android/app/scrollcapture/lib/RemoteScrollCaptureInterface$ConnectionListener;->onConnectionResult(Z)V
...
.method public notifyGlobalScreenshotFinished(JLjava/lang/String;Landroid/os/Bundle;)Z
    ...
    const-string/jumbo v1, "notifyGlobalScreenshotFinished"
    ...
    const-string/jumbo p0, "notifyGlobalScreenshotFinished : No service connection"
    ...
    const-string/jumbo p3, "notifyGlobalScreenshotFinished : e="
...
.method public notifyGlobalScreenshotStarted(JLjava/lang/String;Landroid/os/Bundle;)Z
    ...
    const-string/jumbo v1, "notifyGlobalScreenshotStarted"
    ...
    const-string/jumbo p0, "notifyGlobalScreenshotStarted : No service connection"
    ...
    const-string/jumbo p3, "notifyGlobalScreenshotStarted : e="
