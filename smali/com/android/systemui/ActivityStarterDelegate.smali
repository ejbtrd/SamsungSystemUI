...
.method public static synthetic $r8$lambda$EUumRbKjz2BPWTLgrIbOHvNTjwk(Landroid/content/Intent;ZLcom/android/systemui/plugins/ActivityStarter$Callback;Ldagger/Lazy;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/android/systemui/ActivityStarterDelegate;->lambda$startCameraActivity$16(Landroid/content/Intent;ZLcom/android/systemui/plugins/ActivityStarter$Callback;Ldagger/Lazy;)V
...
.method public static synthetic $r8$lambda$VzYwcJ5ugviRnjiK4jlV9FrIJs0(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;ZZLdagger/Lazy;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lcom/android/systemui/ActivityStarterDelegate;->lambda$dismissKeyguardThenExecute$15(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;ZZLdagger/Lazy;)V
...
.method private static synthetic lambda$dismissKeyguardThenExecute$15(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;ZZLdagger/Lazy;)V
    .locals 0
    ...
    invoke-virtual {p4, p0, p1, p2, p3}, Lcom/android/systemui/statusbar/phone/StatusBar;->dismissKeyguardThenExecute(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;ZZ)V
...
.method private static synthetic lambda$startCameraActivity$16(Landroid/content/Intent;ZLcom/android/systemui/plugins/ActivityStarter$Callback;Ldagger/Lazy;)V
    .locals 0
    ...
    invoke-virtual {p3, p0, p1, p2}, Lcom/android/systemui/statusbar/phone/StatusBar;->startCameraActivity(Landroid/content/Intent;ZLcom/android/systemui/plugins/ActivityStarter$Callback;)V
...
.method public dismissKeyguardThenExecute(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;Z)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lcom/android/systemui/ActivityStarterDelegate$$ExternalSyntheticLambda14;-><init>(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;Z)V
...
.method public dismissKeyguardThenExecute(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;ZZ)V
    ...
    new-instance v0, Lcom/android/systemui/ActivityStarterDelegate$$ExternalSyntheticLambda15;

    invoke-direct {v0, p1, p2, p3, p4}, Lcom/android/systemui/ActivityStarterDelegate$$ExternalSyntheticLambda15;-><init>(Lcom/android/systemui/plugins/ActivityStarter$OnDismissAction;Ljava/lang/Runnable;ZZ)V
...
.method public postQSRunnableDismissingKeyguard(Ljava/lang/Runnable;)V
    ...
    new-instance v0, Lcom/android/systemui/ActivityStarterDelegate$$ExternalSyntheticLambda16;

    invoke-direct {v0, p1}, Lcom/android/systemui/ActivityStarterDelegate$$ExternalSyntheticLambda16;-><init>(Ljava/lang/Runnable;)V
...
.method public startActivity(Landroid/content/Intent;ZLcom/android/systemui/plugins/ActivityStarter$Callback;)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lcom/android/systemui/ActivityStarterDelegate$$ExternalSyntheticLambda11;-><init>(Landroid/content/Intent;ZLcom/android/systemui/plugins/ActivityStarter$Callback;)V
...
.method public startActivity(Landroid/content/Intent;ZZ)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lcom/android/systemui/ActivityStarterDelegate$$ExternalSyntheticLambda12;-><init>(Landroid/content/Intent;ZZ)V
...
.method public startActivity(Landroid/content/Intent;ZZI)V
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Lcom/android/systemui/ActivityStarterDelegate$$ExternalSyntheticLambda13;-><init>(Landroid/content/Intent;ZZI)V
